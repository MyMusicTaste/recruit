...
### 개발 문화
마이뮤직테이스트의 개발자들은 top-down 방식으로 일하지 않습니다. 개발자들은 스펙을 짜는 도구가 아니라 회사내의 정보를 모두 공유할수 있게 하고 각각의 공연에 대한 결정에 대해 informed decision을 내리도록 하는 환경을 만들어야하는 사명을 가지고 일하고 있습니다.우리가 보다 나은 informed decision을 하기위해서 남들의 경험을 듣는 것보다, 본인이 직접 경험하는 것이야말로 온전히 자기 것이 될 수 있기 때문입니다.

저희는 스스로 아래와 같은 질문을 하며 자부심을 가지고 일하고 있습니다.
- 우리 나라의 여러 서비스 중에서 MSA 로 전세계 트래픽을 처리하는곳이 얼마나 될까요?
- 우리나라의 B2C 서비스중에 국내 트래픽이 1%미만 인 곳이 얼마나 될까요?
- 콘서트 어나운스를 하면 전세계에서 트래픽이 몰리는곳이 얼마나 될까요?
- 이미 완성되어 운영되는 것이 아니라, 계속 기존 시스템을 개선하는 과제의 필요성이 절실히 존재하고 실제로 추진하고 작은 성공을 만들어 가는 곳이 얼마나 될까요?
